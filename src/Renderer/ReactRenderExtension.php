...
class ReactRenderExtension
{
    ...
    public function htmlOptionsToString($a)
    {
        return implode(" ", array_map(function($e, $k) { return $e."=\"".$k."\""; }, array_keys($a), $a));
    }
    ...
    public function reactRenderComponentArray($componentName, array $options = array())
    {
        ...
        $str .= '<div id="'.$data['dom_id'].'" '.$this->htmlOptionsToString($options['htmlOptions']).'>';
